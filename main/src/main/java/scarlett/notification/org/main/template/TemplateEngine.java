        ...
        if (eventEntity.isPresent()) {
            ...
            return event.getTemplates()
                        ...
                        .map(el -> {
                            ...
                            // что отправлять
                            messageBuilder.body(templateTranslation.getBody()); // TODO сделать генерацию текста
                            messageBuilder.subject(templateTranslation.getSubject()); //TODO сделать генерацию текста
